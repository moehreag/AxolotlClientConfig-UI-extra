...
public abstract class EntryListWidget<E extends EntryListWidget.Entry<E>> extends AbstractParentElement implements Drawable, Selectable, DrawingUtil {
	...
	protected void renderHeader(int x, int y) {
	}
	...
	public void render(int mouseX, int mouseY, float delta) {
		...
		if (this.renderBackground) {
			...
			bufferBuilder.vertex(this.left, this.bottom, 0.0, (float) this.left / 32.0f, (float) (this.bottom + (int) this.getScrollAmount()) / 32.0f);
			bufferBuilder.color(32, 32, 32, 255);
			bufferBuilder.vertex(this.right, this.bottom, 0.0, (float) this.right / 32.0f, (float) (this.bottom + (int) this.getScrollAmount()) / 32.0f);
			bufferBuilder.color(32, 32, 32, 255);
			bufferBuilder.vertex(this.right, this.top, 0.0, (float) this.right / 32.0f, (float) (this.top + (int) this.getScrollAmount()) / 32.0f);
			bufferBuilder.color(32, 32, 32, 255);
			bufferBuilder.vertex(this.left, this.top, 0.0, (float) this.left / 32.0f, (float) (this.top + (int) this.getScrollAmount()) / 32.0f);
			bufferBuilder.end();
		}
		...
		if (this.renderHorizontalShadows) {
			...
			int m = -100;
			bufferBuilder.start(7);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left, this.top, -100.0, 0.0f, (float) this.top / 32.0f);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left + this.width, this.top, -100.0, (float) this.width / 32.0f, (float) this.top / 32.0f);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left + this.width, 0.0, -100.0, (float) this.width / 32.0f, 0.0f);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left, 0.0, -100.0, 0.0f, 0.0f);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left, this.height, -100.0, 0.0f, (float) this.height / 32.0f);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left + this.width, this.height, -100.0, (float) this.width / 32.0f, (float) this.height / 32.0f);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left + this.width, this.bottom, -100.0, (float) this.width / 32.0f, (float) this.bottom / 32.0f);
			bufferBuilder.color(64, 64, 64, 255);
			bufferBuilder.vertex(this.left, this.bottom, -100.0, 0.0f, (float) this.bottom / 32.0f);
			bufferBuilder.end();
			...
			bufferBuilder.vertex(this.left, this.top + 4, 0.0, 0.0f, 1.0f);
			bufferBuilder.color(0, 0, 0, 0);
			bufferBuilder.vertex(this.right, this.top + 4, 0.0, 1.0f, 1.0f);
			bufferBuilder.color(0, 0, 0, 255);
			bufferBuilder.vertex(this.right, this.top, 0.0, 1.0f, 0.0f);
			bufferBuilder.color(0, 0, 0, 255);
			bufferBuilder.vertex(this.left, this.top, 0.0, 0.0f, 0.0f);
			bufferBuilder.color(0, 0, 0, 255);
			bufferBuilder.vertex(this.left, this.bottom, 0.0, 0.0f, 1.0f);
			bufferBuilder.color(0, 0, 0, 255);
			bufferBuilder.vertex(this.right, this.bottom, 0.0, 1.0f, 1.0f);
			bufferBuilder.color(0, 0, 0, 0);
			bufferBuilder.vertex(this.right, this.bottom - 4, 0.0, 1.0f, 0.0f);
			bufferBuilder.color(0, 0, 0, 0);
			bufferBuilder.vertex(this.left, this.bottom - 4, 0.0, 0.0f, 0.0f);
			bufferBuilder.end();
		}
		...
		if (o > 0) {
			...
			//DrawUtil.fillRect(i, this.top, j-i, this.bottom-this.top, Colors.BLACK.toInt());
			...
			bufferBuilder.color(0, 0, 0, 255);
			bufferBuilder.vertex(j, this.bottom, 0.0, 1.0F, 1.0F);
			bufferBuilder.color(0, 0, 0, 255);
			bufferBuilder.vertex(j, this.top, 0.0, 1.0F, 0.0F);
			bufferBuilder.color(0, 0, 0, 255);
			bufferBuilder.vertex(i, this.top, 0.0, 0.0F, 0.0F);
			bufferBuilder.color(128, 128, 128, 255);
			bufferBuilder.vertex(i, (q + p), 0.0, 0.0F, 1.0F);
			bufferBuilder.color(128, 128, 128, 255);
			bufferBuilder.vertex(j, (q + p), 0.0, 1.0F, 1.0F);
			bufferBuilder.color(128, 128, 128, 255);
			bufferBuilder.vertex(j, q, 0.0, 1.0F, 0.0F);
			bufferBuilder.color(128, 128, 128, 255);
			bufferBuilder.vertex(i, q, 0.0, 0.0F, 0.0F);
			bufferBuilder.color(192, 192, 192, 255);
			bufferBuilder.vertex(i, (q + p - 1), 0.0, 0.0F, 1.0F);
			bufferBuilder.color(192, 192, 192, 255);
			bufferBuilder.vertex((j - 1), (q + p - 1), 0.0, 1.0F, 1.0F);
			bufferBuilder.color(192, 192, 192, 255);
			bufferBuilder.vertex((j - 1), q, 0.0, 1.0F, 0.0F);
			bufferBuilder.color(192, 192, 192, 255);
			bufferBuilder.vertex(i, q, 0.0, 0.0F, 0.0F);
			bufferBuilder.end();
		}
	...
	public void setScrollAmount(double amount) {
		this.scrollAmount = MathUtil.clamp(amount, 0.0, this.getMaxScroll());
	}
	...
	public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
		if (super.mouseDragged(mouseX, mouseY, button, deltaX, deltaY)) {
			...
			if (mouseY < (double) this.top) {
				...
				int j = MathUtil.clamp((int) ((float) (i * i) / (float) this.getMaxPosition()), 32, i - 8);
	...
	protected boolean moveSelection(MoveDirection direction, Predicate<E> predicate) {
		...
		if (!this.children().isEmpty()) {
			...
			while (true) {
				int k = MathUtil.clamp(j + i, 0, this.getEntryCount() - 1);
				if (j == k) {
					break;
				}
